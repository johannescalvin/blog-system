...
import org.atlassian.commonmark.ext.catalog.internal.HeadingIdAttributeProvider;
 ...
 */
public class HeadingIdExtension implements HtmlRenderer.HtmlRendererExtension {

    private final String defaultId;
    private final String idPrefix;
    private final String idSuffix;

    private HeadingIdExtension(Builder builder) {
    ...
    public static Extension create() {
        return new HeadingIdExtension(builder());
    }
    ...
    public static class Builder {
        ...
        public Extension build() {
            return new HeadingIdExtension(this);
        }
    }
}
